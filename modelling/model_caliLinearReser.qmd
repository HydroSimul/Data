...
In this article, we will learn how to manage the entire hydrological modeling process with the minimal model  [Linear-Reservoir model](model_linearReservoir.qmd), including automatic calibration.
...
You can access detailed information about the model using the `help(model_linearReservoir)` or `?model_linearReservoir` commands. This will provide you with a description of the model's functionality and usage. Alternatively, you can also find information about the model online in the [model_linearReservoir documentation](https://hydrosimul.github.io/HydroCourse/reference/model.html).
