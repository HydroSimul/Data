...
- Harmonic Mean: The harmonic mean is used for rates and ratios, such as speed or efficiency. It's calculated by dividing the number of values by the sum of their reciprocals.
...
$$ 
\text{Quantile}(q) = x_{\lfloor i \rfloor} + (i - \lfloor i \rfloor) \cdot (x_{\lfloor i \rfloor + 1} - x_{\lfloor i \rfloor}) 
$$
...
$$
q_{C}={\frac{P_{75}-P_{25}}{P_{75}+P_{25}}} 
$$
...
$$
q s=\frac{\left(P_{75}-P_{50}\,\right)-\left(P_{50}-P_{25}\,\right)}{P_{75}-P_{25}} 
$$
